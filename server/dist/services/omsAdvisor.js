...
class OMSAdvisor {
     ...
     */
    static analyzeDailyIntake(dailyLogs, targets) {
    ...
    static checkCalories(calories, target, recs) {
    ...
    static checkMacros(totals, targets, recs) {
        // Proteínas
    ...
    static checkWarnings(totals, targets, recs) {
        // Azúcar
...
exports.OMSAdvisor = OMSAdvisor;
//# sourceMappingURL=omsAdvisor.js.map