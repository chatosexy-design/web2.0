...
class NutritionCalculator {
     ...
     */
    static calculateTMB(weight, height, age, sex) {
        if (sex === 'M') {
     ...
     */
    static calculateDailyCalories(tmb, activityLevel, goal) {
     ...
     */
    static getDetailedTargets(student) {
...
//# sourceMappingURL=nutritionCalculator.js.map