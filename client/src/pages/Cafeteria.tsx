        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {dishes.map((dish) => (
            <div key={dish.id} className="card-premium p-8 group cursor-pointer">
              ...
              <p className="text-sm text-stone-500 mb-8 font-medium">{dish.description || 'Sin descripción'}</p>
              <div className="flex items-center justify-between pt-6 border-t border-stone-100 dark:border-stone-800">
                ...
                <button className="px-6 py-2 bg-sano-50 text-sano-700 rounded-xl text-xs font-bold hover:bg-sano-600 hover:text-white transition-all">
                  Consumir
                </button>
              </div>
            </div>
